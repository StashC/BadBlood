...
public abstract class bruteEnemy : MonoBehaviour
{
    [Header("Component References")]
    public GameObject _timerPrefab;
    ...
    void UpdateState()
    {
        ...
        //If in range && can attack, attack.  If can't attack, seek.  Always face player.
        if(hit.distance <= _attackingRange && canAttack)
        {
            FacePlayer();           
    ...
    {
        if(currState != State.Attacking) UpdateState();
